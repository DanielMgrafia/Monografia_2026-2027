...
namespace RepositorioAcademico.Server.Migrations
{
    ...
    [Migration("20260921011341_AddDocumentResearchClassification")]
    partial class AddDocumentResearchClassification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepositorioAcademico.Server.Domain.Documento", b =>
                {
                    ...
                    b.Property<int?>("SublineaInvestigacionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SublineaInvestigacionId");
            ...
            modelBuilder.Entity("RepositorioAcademico.Server.Domain.DocumentoDescarga", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DocumentoDescargas");
                });

            modelBuilder.Entity("RepositorioAcademico.Server.Domain.DocumentoFavorito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UsuarioId", "DocumentoId")
                        .IsUnique();

                    b.ToTable("DocumentoFavoritos");
                });

            modelBuilder.Entity("RepositorioAcademico.Server.Domain.DocumentoVista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RepositorioAcademico.Server.Domain.Documento", b =>
                {
                    ...
                    b.HasOne("RepositorioAcademico.Server.Domain.SublineaInvestigacion", "SublineaInvestigacion")
                        .WithMany()
                        .HasForeignKey("SublineaInvestigacionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("RepositorioAcademico.Server.Domain.DocumentoDescarga", b =>
                {
                    b.HasOne("RepositorioAcademico.Server.Domain.Documento", "Documento")
                        .WithMany("Descargas")
                    ...
                    b.HasOne("RepositorioAcademico.Server.Domain.Usuario", "Usuario")
                        .WithMany("DocumentosDescargados")
                        .HasForeignKey("UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RepositorioAcademico.Server.Domain.Usuario", b =>
                {
                    ...
                    b.Navigation("DocumentosDescargados");

                    b.Navigation("DocumentosFavoritos");

                    b.Navigation("DocumentosVistos");
