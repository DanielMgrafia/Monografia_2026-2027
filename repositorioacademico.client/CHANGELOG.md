...
- Cree un proyecto de Angular con ng: `ng new repositorioacademico.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`repositorioacademico.client.esproj`).
